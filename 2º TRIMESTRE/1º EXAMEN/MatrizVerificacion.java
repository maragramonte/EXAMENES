/* FUNCION verificarDiagonales(matriz)
    ...
    SI matriz ES NULO O matriz.tamaño ES 0 O matriz[0].tamaño ES 0 ENTONCES
        RETORNAR FALSO
    FIN SI

    // Crear conjuntos para almacenar los elementos de la primera columna y la última fila
    CONJUNTO primeraColumna
    CONJUNTO ultimaFila

    // Recorrer la matriz para llenar los conjuntos
    PARA i DESDE 0 HASTA matriz.tamaño - 1 HACER
        // Agregar el elemento de la primera columna
        primeraColumna.AÑADIR(matriz[i][0])
    FIN PARA

    // Recorrer la última fila
    ultimaFilaIndex = matriz.tamaño - 1
    PARA j DESDE 0 HASTA matriz[ultimaFilaIndex].tamaño - 1 HACER
        // Agregar el elemento de la última fila
        ultimaFila.AÑADIR(matriz[ultimaFilaIndex][j])
    FIN PARA

    // Verificar si hay un solo elemento en cada conjunto
    RETORNAR (primeraColumna.tamaño == 1 Y ultimaFila.tamaño == 1)
FIN FUNCION

FUNCION principal()
    // Ejemplos de uso
    IMPRIMIR verificarDiagonales([[1, 2, 3], [1, 2, 3], [1, 2, 3]]) // true
    IMPRIMIR verificarDiagonales([[1, 2, 3], [4, 5, 6], [7, 8, 9]]) // false
    IMPRIMIR verificarDiagonales([[2, 2, 2], [2, 2, 2], [2, 2, 2]]) // true
    IMPRIMIR verificarDiagonales([[1, 2], [1, 2], [1, 3]]) // false
FIN FUNCION */
